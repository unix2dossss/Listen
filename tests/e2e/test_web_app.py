...
# #         ('us', '', b'This username is already taken!'),
# #         ('newuser', '', b'Your password is required'),
# #         ('newuser', 'pass', b'Your password must be at least 8 characters, and contain an upper case letter,\
# #             a lower case letter and a digit'),
# #         ('Shyamli', 'Testing235', b'This username is already taken!'),
# # ))
# # def test_register_with_invalid_input(client, username, password, message):
# #     # Check that attempting to register with invalid combinations generates appropriate error messages.
# #     response = client.post(
# #         '/auth/register',
...
#     response = auth.login(user_name='Testing')
...
#         client.get('/')
#         assert session['username'] == 'Testing'
#
#
#
# @pytest.mark.parametrize(('username', 'password', 'message'), (
#         ('unknown_user', 'ValidPass1', b'This username is not registered!'),
#         ('johndoe', 'WrongPass1', b'The specified password does not match the username!'),
# ))
# def test_login_with_invalid_input(client, username, password, message):
#     # Attempt login with invalid credentials and check appropriate error messages.
#     response = client.post(
#         '/auth/login',
#         data={'username': username, 'password': password}
#     )
